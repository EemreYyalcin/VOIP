...
public class PDCSOSPSHeader extends SipMessageHeader{

    private String pDCSOSPS;
	...
	try {
	    ...
	    pDCSOSPS = message.substring(0, endIndex);
	...
	return "P-DCS-OSPS: " + pDCSOSPS + appendParameter();
    }
