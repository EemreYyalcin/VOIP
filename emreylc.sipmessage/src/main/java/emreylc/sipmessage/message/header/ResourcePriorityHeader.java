...
public class ResourcePriorityHeader extends SipMessageHeader {
	...
	try {
	    ...
	    resourcePriority = message.substring(0, endIndex);
	...
	return "Resource-Priority: " + resourcePriority + appendParameter();
    }
