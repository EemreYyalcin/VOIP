...
public class PDCSRedirectHeader extends SipMessageHeader{

    private String pDCSRedirect;
	...
	try {
	    ...
	    pDCSRedirect = message.substring(0, endIndex);
	...
	return "P-DCS-Redirect: " + pDCSRedirect + appendParameter();
    }
