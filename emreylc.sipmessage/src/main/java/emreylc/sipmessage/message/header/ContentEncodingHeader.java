...
public class ContentEncodingHeader extends SipMessageHeader {
	...
	try {
	    ...
	    contentEncoding = message.substring(0, endIndex);
	...
	return "Content-Encoding: " + contentEncoding + appendParameter();
    }
