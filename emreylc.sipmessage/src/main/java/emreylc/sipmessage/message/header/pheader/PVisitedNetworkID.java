...
public class PVisitedNetworkID extends SipMessageHeader {

    private String pVisitedNetworkID;
	...
	try {
	    ...
	    pVisitedNetworkID = message.substring(0, endIndex);
	...
	return "P-Visited-Network-ID: " + pVisitedNetworkID + appendParameter();
    }
