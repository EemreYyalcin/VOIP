...
public class PDCSLAESHeader extends SipMessageHeader{

    private String pDCSLAES;
	...
	try {
	    ...
	    pDCSLAES = message.substring(0, endIndex);
	...
	return "P-DCS-LAES: " + pDCSLAES + appendParameter();
    }
