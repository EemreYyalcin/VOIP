...
public class PDCSBillingInfo extends SipMessageHeader {

    private String pDCSBillingInfo;
	...
	try {
	    ...
	    pDCSBillingInfo = message.substring(0, endIndex);
	...
	return "P-DCS-Billing-Info: " + pDCSBillingInfo + appendParameter();
    }
