...
public class PCalledPartyIDHeader extends SipMessageHeader {

    private String pCalledPartyID;
	...
	try {
	    ...
	    pCalledPartyID = message.substring(0, endIndex);
	...
	return "P-Called-Party-ID: " + pCalledPartyID + appendParameter();
    }
