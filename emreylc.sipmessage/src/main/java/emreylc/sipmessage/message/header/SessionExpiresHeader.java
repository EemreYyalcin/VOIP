...
public class SessionExpiresHeader extends SipMessageHeader {
	...
	try {
	    ...
	    sessionExpires = message.substring(0, endIndex);
	...
	return "Session-Expires: " + sessionExpires + appendParameter();
    }
