...
public class PChargingFunctionAddressesHeader extends SipMessageHeader {

    private String pChargingFunctionAddresses;
	...
	try {
	    ...
	    pChargingFunctionAddresses = message.substring(0, endIndex);
	...
	return "P-Changing-Function-Addresses: " + pChargingFunctionAddresses + appendParameter();
    }
