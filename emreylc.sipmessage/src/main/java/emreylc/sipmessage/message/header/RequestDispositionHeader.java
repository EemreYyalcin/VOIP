...
public class RequestDispositionHeader extends SipMessageHeader {
	...
	try {
	    ...
	    requestDisposition = message.substring(0, endIndex);
	...
	return "Request-Disposition: " + requestDisposition + appendParameter();
    }
