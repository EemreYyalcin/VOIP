...
public class ReferSubHeader extends SipMessageHeader {

    private String referSubValue;
	...
	try {
	    ...
	    referSubValue = message.substring(0, endIndex);
	...
	return "Refer-Sub: " + referSubValue + appendParameter();
    }
