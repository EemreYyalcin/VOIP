...
public class PAssociatedURIHeader extends SipMessageHeader {
	...
	try {
	    ...
	    pAssociatedURI = message.substring(0, endIndex);
	...
	return "P-Associated-URI: " + pAssociatedURI + appendParameter();
    }
