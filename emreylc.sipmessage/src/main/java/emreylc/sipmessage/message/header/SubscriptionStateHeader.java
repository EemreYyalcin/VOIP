...
public class SubscriptionStateHeader extends SipMessageHeader {
	...
	try {
	    ...
	    subscriptionState = message.substring(0, endIndex);
	...
	return "Subscription-State: " + subscriptionState + appendParameter();
    }
