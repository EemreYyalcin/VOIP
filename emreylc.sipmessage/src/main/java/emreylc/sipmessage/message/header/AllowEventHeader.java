...
public class AllowEventHeader extends SipMessageHeader {

    private String allowEvent;
	...
	try {
	    ...
	    allowEvent = message.substring(0, endIndex);
	...
	return "Allow-Events: " + allowEvent + appendParameter();
    }
