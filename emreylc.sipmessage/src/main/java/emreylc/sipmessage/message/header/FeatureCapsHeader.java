...
public class FeatureCapsHeader extends SipMessageHeader {

    private String featureCaps;
	...
	try {
	    ...
	    featureCaps = message.substring(0, endIndex);
	...
	return "Feature-Caps: " + featureCaps + appendParameter();
    }
