...
public class PAccessNetworkInfoHeader extends SipMessageHeader {
	...
	try {
	    ...
	    pAccessNetworkInfo = message.substring(0, endIndex);
	...
	return "P-Access-Network-Info: " + pAccessNetworkInfo + appendParameter();
    }
