...
public class PolicyContactHeader extends SipMessageHeader {
	...
	try {
	    ...
	    policyContact = message.substring(0, endIndex);
	...
	return "Policy-Contact: " + policyContact + appendParameter();
    }
