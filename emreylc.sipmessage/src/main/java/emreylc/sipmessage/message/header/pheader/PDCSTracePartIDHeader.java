...
public class PDCSTracePartIDHeader extends SipMessageHeader{

    private String pDCSTracePartID;
	...
	try {
	    ...
	    pDCSTracePartID = message.substring(0, endIndex);
	...
	return "P-DCS-Trace-Party-ID: " + pDCSTracePartID + appendParameter();
    }
