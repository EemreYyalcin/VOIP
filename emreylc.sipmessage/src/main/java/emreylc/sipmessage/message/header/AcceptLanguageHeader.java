...
public class AcceptLanguageHeader extends SipMessageHeader {
	...
	try {
	    ...
	    acceptLanguage = message.substring(0, endIndex);
	...
	return "Accept-Language: " + acceptLanguage + appendParameter();
    }
